...
public class TestDataInit {
    ...
    static class InitService {
        ...
        public void memberInit() {
            Member springMember = getMember("spring", "1234", "스프링", "spring@spring.com", Role.ROLE_USER, "19901009", Gender.M, new Mobile("010", "4250", "4296"), new Address("00000", "Sejong", "101호"));
            Member adminMember = getMember("admin", "1234", "관리자", "admin@spring.com", Role.ROLE_ADMIN, "20001009", Gender.F, new Mobile("010", "4250", "4296"), new Address("00000", "Sejong", "101호"));
